...
export function buildPactBladeVirtualDefinition(template: PactBladeWeaponTemplate): ItemDefinitionEntry {
  ...
  return {
    ...
    valueCurrency: null,
    valueAmount: null,
    weaponProficiencyGroup: ["club", "dagger", "greatclub", "handaxe", "javelin", "light-hammer", "mace", "quarterstaff", "sickle", "spear"].includes(template.id) ? "SIMPLE" : "MARTIAL",
    isLightWeapon: template.properties?.includes("Leggera") ?? false,
    data: null,
