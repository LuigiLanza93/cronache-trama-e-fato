...
const rules2014Source = Object.freeze({
  rulesetId: "dnd-5e-2014",
  version: "2014",
  reference: "Manuale del Giocatore 5.0, capitolo 3",
});
...
export const SUBCLASS_RULES = Object.freeze({
  berserker: Object.freeze({ key: "berserker", classKey: "barbarian", labels: Object.freeze({ it: "Cammino del Berserker", en: "Path of the Berserker" }), aliases: Object.freeze(["berserker", "Berserker", "Cammino del Berserker", "Path of the Berserker"]), source }),
  "path-of-the-totem-warrior": Object.freeze({ key: "path-of-the-totem-warrior", classKey: "barbarian", labels: Object.freeze({ it: "Cammino del Combattente Totemico", en: "Path of the Totem Warrior" }), aliases: Object.freeze(["path-of-the-totem-warrior", "Cammino del Combattente Totemico", "Path of the Totem Warrior"]), source: rules2014Source }),
  "college-of-lore": Object.freeze({ key: "college-of-lore", classKey: "bard", labels: Object.freeze({ it: "Collegio della Sapienza", en: "College of Lore" }), aliases: Object.freeze(["college-of-lore", "Collegio della Sapienza", "Collegio del Sapere", "College of Lore"]), source }),
  "college-of-valour": Object.freeze({ key: "college-of-valour", classKey: "bard", labels: Object.freeze({ it: "Collegio del Valore", en: "College of Valour" }), aliases: Object.freeze(["college-of-valour", "Collegio del Valore", "College of Valour", "College of Valor"]), source: rules2014Source }),
  "knowledge-domain": Object.freeze({ key: "knowledge-domain", classKey: "cleric", labels: Object.freeze({ it: "Dominio della Conoscenza", en: "Knowledge Domain" }), aliases: Object.freeze(["knowledge-domain", "Dominio della Conoscenza", "Knowledge Domain"]), source: rules2014Source }),
  ...
  "light-domain": Object.freeze({ key: "light-domain", classKey: "cleric", labels: Object.freeze({ it: "Dominio della Luce", en: "Light Domain" }), aliases: Object.freeze(["light-domain", "Dominio della Luce", "Light Domain"]), source: rules2014Source }),
  "nature-domain": Object.freeze({ key: "nature-domain", classKey: "cleric", labels: Object.freeze({ it: "Dominio della Natura", en: "Nature Domain" }), aliases: Object.freeze(["nature-domain", "Dominio della Natura", "Nature Domain"]), source: rules2014Source }),
  "tempest-domain": Object.freeze({ key: "tempest-domain", classKey: "cleric", labels: Object.freeze({ it: "Dominio della Tempesta", en: "Tempest Domain" }), aliases: Object.freeze(["tempest-domain", "Dominio della Tempesta", "Tempest Domain"]), source: rules2014Source }),
  "trickery-domain": Object.freeze({ key: "trickery-domain", classKey: "cleric", labels: Object.freeze({ it: "Dominio dell'Inganno", en: "Trickery Domain" }), aliases: Object.freeze(["trickery-domain", "Dominio dell'Inganno", "Trickery Domain"]), source: rules2014Source }),
  "war-domain": Object.freeze({ key: "war-domain", classKey: "cleric", labels: Object.freeze({ it: "Dominio della Guerra", en: "War Domain" }), aliases: Object.freeze(["war-domain", "Dominio della Guerra", "War Domain"]), source: rules2014Source }),
  ...
  "circle-of-the-moon": Object.freeze({ key: "circle-of-the-moon", classKey: "druid", labels: Object.freeze({ it: "Circolo della Luna", en: "Circle of the Moon" }), aliases: Object.freeze(["circle-of-the-moon", "Circolo della Luna", "Circle of the Moon"]), source: rules2014Source }),
  "battle-master": Object.freeze({ key: "battle-master", classKey: "fighter", labels: Object.freeze({ it: "Maestro di Battaglia", en: "Battle Master" }), aliases: Object.freeze(["battle-master", "Maestro di Battaglia", "Battle Master"]), source: rules2014Source }),
  ...
  "way-of-shadow": Object.freeze({ key: "way-of-shadow", classKey: "monk", labels: Object.freeze({ it: "Via dell'Ombra", en: "Way of Shadow" }), aliases: Object.freeze(["way-of-shadow", "Via dell'Ombra", "Way of Shadow"]), source: rules2014Source }),
  "way-of-the-four-elements": Object.freeze({ key: "way-of-the-four-elements", classKey: "monk", labels: Object.freeze({ it: "Via dei Quattro Elementi", en: "Way of the Four Elements" }), aliases: Object.freeze(["way-of-the-four-elements", "Via dei Quattro Elementi", "Way of the Four Elements"]), source: rules2014Source }),
  ...
  "oath-of-the-ancients": Object.freeze({ key: "oath-of-the-ancients", classKey: "paladin", labels: Object.freeze({ it: "Giuramento degli Antichi", en: "Oath of the Ancients" }), aliases: Object.freeze(["oath-of-the-ancients", "Giuramento degli Antichi", "Oath of the Ancients"]), source: rules2014Source }),
  ...
  "oath-of-vengeance": Object.freeze({ key: "oath-of-vengeance", classKey: "paladin", labels: Object.freeze({ it: "Giuramento di Vendetta", en: "Oath of Vengeance" }), aliases: Object.freeze(["oath-of-vengeance", "Giuramento di Vendetta", "Oath of Vengeance"]), source: rules2014Source }),
  ...
  "beast-master": Object.freeze({ key: "beast-master", classKey: "ranger", labels: Object.freeze({ it: "Signore delle Bestie", en: "Beast Master" }), aliases: Object.freeze(["beast-master", "Signore delle Bestie", "Beast Master"]), source: rules2014Source }),
  assassin: Object.freeze({ key: "assassin", classKey: "rogue", labels: Object.freeze({ it: "Assassino", en: "Assassin" }), aliases: Object.freeze(["assassin", "Assassino"]), source: rules2014Source }),
  ...
  "draconic-bloodline": Object.freeze({ key: "draconic-bloodline", classKey: "sorcerer", labels: Object.freeze({ it: "Discendenza Draconica", en: "Draconic Bloodline" }), aliases: Object.freeze(["draconic-bloodline", "Discendenza Draconica", "Stirpe Draconica", "Draconic Bloodline"]), source }),
  "wild-magic": Object.freeze({ key: "wild-magic", classKey: "sorcerer", labels: Object.freeze({ it: "Magia Selvaggia", en: "Wild Magic" }), aliases: Object.freeze(["wild-magic", "Magia Selvaggia", "Wild Magic"]), source: rules2014Source }),
  "the-archfey": Object.freeze({ key: "the-archfey", classKey: "warlock", labels: Object.freeze({ it: "Il Signore Fatato", en: "The Archfey" }), aliases: Object.freeze(["the-archfey", "Il Signore Fatato", "The Archfey"]), source: rules2014Source }),
  ...
  "the-great-old-one": Object.freeze({ key: "the-great-old-one", classKey: "warlock", labels: Object.freeze({ it: "Il Grande Antico", en: "The Great Old One" }), aliases: Object.freeze(["the-great-old-one", "Il Grande Antico", "The Great Old One"]), source: rules2014Source }),
  "school-of-abjuration": Object.freeze({ key: "school-of-abjuration", classKey: "wizard", labels: Object.freeze({ it: "Scuola di Abiurazione", en: "School of Abjuration" }), aliases: Object.freeze(["school-of-abjuration", "Scuola di Abiurazione", "School of Abjuration"]), source: rules2014Source }),
  "school-of-enchantment": Object.freeze({ key: "school-of-enchantment", classKey: "wizard", labels: Object.freeze({ it: "Scuola di Ammaliamento", en: "School of Enchantment" }), aliases: Object.freeze(["school-of-enchantment", "Scuola di Ammaliamento", "School of Enchantment"]), source: rules2014Source }),
  "school-of-conjuration": Object.freeze({ key: "school-of-conjuration", classKey: "wizard", labels: Object.freeze({ it: "Scuola di Evocazione", en: "School of Conjuration" }), aliases: Object.freeze(["school-of-conjuration", "Scuola di Evocazione", "School of Conjuration"]), source: rules2014Source }),
  "school-of-divination": Object.freeze({ key: "school-of-divination", classKey: "wizard", labels: Object.freeze({ it: "Scuola di Divinazione", en: "School of Divination" }), aliases: Object.freeze(["school-of-divination", "Scuola di Divinazione", "School of Divination"]), source: rules2014Source }),
  ...
  "school-of-illusion": Object.freeze({ key: "school-of-illusion", classKey: "wizard", labels: Object.freeze({ it: "Scuola di Illusione", en: "School of Illusion" }), aliases: Object.freeze(["school-of-illusion", "Scuola di Illusione", "School of Illusion"]), source: rules2014Source }),
  "school-of-necromancy": Object.freeze({ key: "school-of-necromancy", classKey: "wizard", labels: Object.freeze({ it: "Scuola di Negromanzia", en: "School of Necromancy" }), aliases: Object.freeze(["school-of-necromancy", "Scuola di Negromanzia", "School of Necromancy"]), source: rules2014Source }),
  "school-of-transmutation": Object.freeze({ key: "school-of-transmutation", classKey: "wizard", labels: Object.freeze({ it: "Scuola di Trasmutazione", en: "School of Transmutation" }), aliases: Object.freeze(["school-of-transmutation", "Scuola di Trasmutazione", "School of Transmutation"]), source: rules2014Source }),
});
